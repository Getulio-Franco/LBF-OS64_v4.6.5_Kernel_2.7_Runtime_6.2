...
; int k_setjmp(k_exception_frame_t* env -> RDI)
k_setjmp:
    mov [rdi + 0],  rsp
    mov [rdi + 8],  rbp
    
    ; O endereço de retorno para onde o K_EXCEPT deve voltar é o topo da pilha ([rsp])
    mov rax, [rsp]
    mov [rdi + 16], rax
    ...
    mov dword [rdi + 64], 0 ; active = 0 (definido depois pela macro)
    mov dword [rdi + 68], 0 ; last_error = 0
    
    xor eax, eax ; Retorna 0 na primeira chamada
    ret
